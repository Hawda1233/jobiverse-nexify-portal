...
const Scene3DFallback = () => (
  <div className="flex items-center justify-center h-full w-full bg-gray-800 rounded-lg">
    <p className="text-white text-center p-4">Unable to load 3D scene. Please ensure WebGL is enabled in your browser.</p>
  </div>
);
...
const Scene3D: React.FC<Scene3DProps> = ({ 
  ...
  return (
    <div style={{ height, width: '100%', position: 'relative' }}>
      <ErrorBoundary FallbackComponent={Scene3DFallback}>
